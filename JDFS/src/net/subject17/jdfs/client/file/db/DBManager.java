	...
	private void initializeDatabase() throws SQLException {
		...
		try(Connection conn = getConnection();
			...
			statement.executeQuery("CREATE TABLE IF NOT EXISTS UserFiles ("+
							...
							"LocalFileName text NOT NULL, " + //NOTE THE DATATYPE!  MAJOR PREFORMANCE ISSUE POSSIBLE! //Don't think we need this for user files UNUSED
							"LocalFilePath text NOT NULL, " + //including name	//Don't think we need this for user Files UNUSED
							"LastUpdatedLocal DATETIME, " +
							"CheckSum VARCHAR(36), " + //Don't think we want this for user files UNUSED
							"IV BLOB, " + //Don't think we want this for user files UNUSED
